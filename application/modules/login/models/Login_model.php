...
class Login_model extends CI_Model
{
    ...
    // Global View All Data With ORder By
    ...
    // Global View All Data With ORder By
    public function viewAllOrderBy1($select, $tbl, $where, $order)
    {
        $this->db->select($select);
        $this->db->from($tbl);
    ...
    // Global View Order By Limit
    public function viewAllOrderByLimit($select, $tbl, $where)
    {
        $this->db->select($select);
        $this->db->from($tbl);
        $this->db->order_by($where, 'DESC');
    ...
    // Global Count Data Where
    public function countDataWhere($select, $table, $where, $condition)
    {
    ...
    // Global View Where Assosiative Order
    public function viewWhereAssosiativeOrder($select, $tbl, $assosiative, $order)
    {
        $this->db->select($select);
        $this->db->from($tbl);
    ...
    // Global View Where Assosiative Order Limit
    public function viewWhereAssosiativeOrderLimit($select, $tbl, $assosiative, $order, $limit)
    {
        $this->db->select($select);
        $this->db->from($tbl);
    ...
    // Global View Global Where Limit
    public function viewGlobalWhereLimitOrder($select, $tbl, $where, $limit, $order)
    {
        $this->db->select($select);
        $this->db->from($tbl);
        $this->db->where($where);
    ...
    // Datatables Admin View
    public function jsonLimit($select, $table)
    {
        $this->datatables->select($select);
        $this->datatables->from($table);
    ...
    // Get Last Data Where On Table
    public function lastDataWhere($select, $table, $where, $order)
    {
        $this->db->select($select);
        $this->db->from($table);
        $this->db->where($where);
    ...
    // Global View Where Global Assosiative order limit 1
    public function viewWhereAssosOrderLimit($select, $tbl, $where, $order)
    {
        $this->db->select($select);
        $this->db->from($tbl);
        $this->db->where($where);
    ...
    // Global View Where Global Assosiative order limit
    public function viewWhereAssosOrderLimit1($select, $tbl, $where, $order, $limit)
    {
        $this->db->select($select);
        $this->db->from($tbl);
        $this->db->where($where);
    ...
    // Query To Get Response Ajax Select 2
    public function getSelect2($select="", $searchTerm="", $table="", $id="", $where="")
    {
        // Fetch users
        $this->db->select($select);
        $this->db->where($where." like '%".$searchTerm."%' ");
        $fetched_records    = $this->db->get($table);
        $dataRole           = $fetched_records->result_array();
